...
public class FilmAdapter extends RecyclerView.Adapter<FilmAdapter.FilmViewHolder> {
    ...
    public FilmAdapter(Context context, TicketFragment ticketFragment) {
    ...
    public void onBindViewHolder(@NonNull FilmViewHolder holder, int i) {
        ...
        //holder.filmPhoto.setLayoutParams(new RelativeLayout.LayoutParams(180,200));
        ...
        holder.favourite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (filmWithSessions.get(i).film.isFavourite()) {
                    ...
                    ticketFragment.onUpdateButtonClicked(filmWithSessions.get(i).film);
                    holder.favourite.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.ic_favorite_border, 0);
                } else {
                    filmWithSessions.get(i).film.setFavourite(true);
                    ticketFragment.onUpdateButtonClicked(filmWithSessions.get(i).film);
                    holder.favourite.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.ic_favorite, 0);
                }
    ...
    private void openBuy(long idHall, long idSession, String name, long time, int price, long image) {
        Intent intent = new Intent(ticketFragment.getActivity(), BuyTicketActivity.class);
